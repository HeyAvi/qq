    ...
    return WillPopScope(
        ...
        child: SafeArea(
            child: Scaffold(
              ...
              body: Container(
                  padding: EdgeInsets.only(left: 20.w, top: 20.h, right: 20.w, bottom: 0.h),
                    ...
                    listener: (context,state){
                      if(state is TicketsCompleteState){
                        ...
                        if(state.contestUserSubmit && isMove){
                          Navigator.push(context, MaterialPageRoute(builder: (Context) => ContestMainPage()));
                        }
                        else if(state.contestUserSubmit && !isMove){
                          Navigator.push(context, MaterialPageRoute(builder: (Context) => Home(false,false)));
                          DialogUtil.showInfoDialog("You're booked for this contest.", context);
                        }
                      }
                    },
                    child: ListView(
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(child: Text(
                              'ONE STEP AWAY',textAlign: TextAlign.center,
                              style: TextStyle(
                                  fontSize: 20.sp,
                        ...
                        Row(
                          ...
                          children: [
                            (contestService.contestdata != null && contestService.contestdata!.start_date != "")  ? CountdownTimer(
                              ...
                              widgetBuilder: (_, time) {
                                ...
                                return Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        border: Border.all(width: 2.h,color: ColorConstants.primaryColor3)
                                    ),
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        (time.hours.toString() != "null") ? Text(
                                          time.hours.toString(),textAlign: TextAlign.center,
                                          style: TextStyle(
                                              fontSize: 20.sp,
                                        ...
                                        SizedBox(width: 5.w,),
                                        (time.min.toString() != "null") ? Text(
                                          time.min.toString(),textAlign: TextAlign.center,
                                          style: TextStyle(
                                              fontSize: 20.sp,
                                              color: ColorConstants.primaryColor3
                                          ),
                                        ...
                                        SizedBox(width: 5.w,),
                                        (time.sec.toString() != "null") ? Text(
                                          time.sec.toString(),textAlign: TextAlign.center,
                                          style: TextStyle(
                                              fontSize: 20.sp,
                                              color: ColorConstants.primaryColor3
                                          ),
                        ...
                        Row(
                          ...
                          children: [
                            Transform.rotate(
                              angle: -math.pi / 15,
                              child: Image.asset("assets/game_controller_one.png",width: MediaQuery.of(context).size.width.w/1.5,),
                            )
                          ],
                        ),
                        SizedBox(
                        ...
                        Row(
                          ...
                          children: [
                            RotationTransition(
                              ...
                              child: Image.asset("assets/game_controller_two.png",width: MediaQuery.of(context).size.width.w/1.5,),
                            )
                          ],
                        ),
                        SizedBox(
                            ...
                            Expanded(
                                ...
                                child: SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: Text('Practice Play',style: TextStyle(color: Colors.white,fontSize: 15.sp,fontWeight: FontWeight.bold),),
                                  ),
                                )
                            ),
                            SizedBox(width: 20.w,),
                            Expanded(
                                ...
                                child: SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                        BlocProvider.of<TicketsBloc>(context).add(SubmitContextUserEvent(context: context, userId: userId,ticketId: ticketDataList![0].ticket_id,contestId: contestService.contestdata!.contest_id,ticketDataList: ticketDataList));
                                    },
                                    child: Text('Play',style: TextStyle(color: Colors.white,fontSize: 15.sp,fontWeight: FontWeight.bold),),
                                  ),
                                )
                            ),
                          ],
                        ...
                        Padding(
                          ...
                          child: Text('Practice Play users are not eligible for any reward & real ranking on leaderboard.',textAlign:TextAlign.center,style: TextStyle(color: Colors.black,fontSize: 13.sp,),),
                        )
                      ],
                    ),
                  )
