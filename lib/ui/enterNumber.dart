...
class SubmitButtonState extends State<SubmitButton> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<EnterNumberBloc, EnterNumberState>(
        ...
        onTap: (){
          BlocProvider.of<EnterNumberBloc>(context).add(SendOTPEvent(context:context,mobileNumber: BlocProvider.of<EnterNumberBloc>(context).state.mobileNumber.value));
        },
      ),*/
        );
  }
