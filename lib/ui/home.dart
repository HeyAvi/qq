...
class _HomeState extends State<HomeStateful> {
  ...
  void initState() {
    ...
    BlocProvider.of<ProfileBloc>(context).stream.listen((event) {
      ...
      context.read<HomeDashBoardBloc>().add(FetchContestEvent(context: context,userId: userData!.user_id));
      context.read<HomeDashBoardBloc>().add(GetLastContestDataEvent(context: context,date: "",contestdata: null));
      setState(() {
    ...
    Future.delayed(Duration.zero, () {
      ...
      if(widget.isContestOpen == true && !(contestService.userBooked)){
        DialogUtil.showInfoDialog("You're not booked for this contest.", context);
      }
    });
              ...
              listener: (context,state){
                if(state is HomeDashBoardCompleteState){
                  ...
                  if(state.contestdata != null){
                    ...
                    var parsedListJson = jsonDecode(state.contestdata!.rules) as List;
                    String key1 = " ", value1 = "";
        ...
        child: Column(
          ...
          children: [
                      ...
                      child: Row(
                        children: [
                          InkWell(
                            ...
                            child: (userDataService == null || userDataService.walletAmount == "null" ) ? Row(
                              children: [
                                Image.asset("assets/rupee.png",height: 15.h,width: 15.w,color: Colors.white,),
                              ...
                              children: [
                                Image.asset("assets/rupee.png",height: 15.h,width: 15.w,color: Colors.white,),
                                Text(userDataService.walletAmount, textAlign: TextAlign.left, style:  TextStyle(
                                  color: Colors.white, fontSize: 15.sp,
                                  fontWeight: FontWeight.bold,
                                  decoration: TextDecoration.underline,
                                ),),
                                        ...
                                        Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                            children: [
                                              Container(
                                                width: 85.w,
                                                margin: EdgeInsets.only(top: 0.h, left: 5.w, right: 10.w),
                                                ...
                                                child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    color: Colors.white,
                                                    borderRadius: BorderRadius.only(topRight: Radius.circular(15.w), bottomRight: Radius.circular(15.w), topLeft: Radius.circular(15.w), bottomLeft: Radius.circular(15.w) ),
                                                  ),
                                                  child: InkWell(
                                                    onTap: (){
                                                      Navigator.push(context, MaterialPageRoute(builder: (Context)=>BuyTickets()));
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          (userDataService != null ) ? Text(userDataService.totalTickets, style: TextStyle(
                                                          ...
                                                          Container(
                                                            ...
                                                            height: 24.h,
                                                            width: 20.w,
                                                            child: Image.asset("assets/tokens.png",height: 15.h,width:10.h),
                                                            decoration: BoxDecoration(
            ...
            Row(
              ...
              children: [
                SizedBox(width: 20.h,),
                Image.asset("assets/4-2-treasure-picture-thumb.png", height: 100.h,),
                /*Column(
                  mainAxisAlignment: MainAxisAlignment.start,
            ...
            Container(
              height: 30.h,
              child: (contestdata != null ) ? Text(contestdata.name, style: TextStyle(
                  color: Colors.white, fontSize: 25.sp,fontWeight: FontWeight.bold
              ),):Text("No Contest", style: TextStyle(
                  color: Colors.white, fontSize: 25.sp,fontWeight: FontWeight.bold
              ),),
            ),
            (contestdata != null ) ? CountdownTimer(
                      ...
                      children: [
                        Card(
                          child: Container(
                            ...
                            child: Center(
                              child: (time.hours.toString() != "null") ? Text(time.hours.toString(),textAlign: TextAlign.center, style: TextStyle(
                                  fontWeight: FontWeight.bold, color: Colors.white,fontSize: 20.sp
                              ),):Text("00",textAlign: TextAlign.center, style: TextStyle(
                                  fontWeight: FontWeight.bold, color: Colors.white,fontSize: 20.sp
                              ),),
                            ),
                          ),
                      ...
                      children: [
                       Card(
                         child: Container(
                           ...
                           child: Center(
                             child:(time.min.toString() != "null") ? Text(time.min.toString(), textAlign: TextAlign.center,style: TextStyle(
                                 fontWeight: FontWeight.bold, color: Colors.white,fontSize: 20.sp
                             ),):Text("00", textAlign: TextAlign.center,style: TextStyle(
                                 fontWeight: FontWeight.bold, color: Colors.white,fontSize: 20.sp
                             ),),
                      ...
                      children: [
                        Card(
                          child: Container(
                            ...
                            child: Center(
                              child: (time.sec.toString() != "null") ? Text(time.sec.toString(),textAlign: TextAlign.center, style: TextStyle(
                                  fontWeight: FontWeight.bold, color: Colors.white,fontSize: 20.sp
                              ),):Text("00",textAlign: TextAlign.center, style: TextStyle(
                                  fontWeight: FontWeight.bold, color: Colors.white,fontSize: 20.sp
                              ),),
              ...
              children: [
                Expanded(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text("Entries Till Open - ", style: TextStyle(
                          color: Colors.white,
                          fontSize: 13.sp,
                          fontWeight: FontWeight.bold
                      ), ),
                      Text(DateFormatter.getTime(contestdata.start_date), style: TextStyle(
                        color: Colors.white,
                        fontSize: 13.sp,
                          fontWeight: FontWeight.bold
                      ), ),
                ...
                Expanded(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      (userData != null && userData!.is_eligible == "yes") ? Text(" Eligible", style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.bold
                      ),):Text(" Not Eligible", style: TextStyle(
                          color: Colors.white,
                          fontSize: 13.sp,
                          fontWeight: FontWeight.bold
                      ),),
            ...
            (contestdata != null) ? GestureDetector(
               onTap: (){
                 Navigator.push(context, MaterialPageRoute(builder: (Context) => Prices(contestdata.winner_zone)));
               },
              child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: ColorConstants.colorYellow,width: 3.w),
                    boxShadow: [
                      BoxShadow(
                        blurRadius: 16.0,
                  ...
                  child: Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Image.asset("assets/trophyTall.png",height: 25.h,width: 25.w),
                      SizedBox(width:0.h),
                      Text(
                        "Winners  &  Prize",
  ...
  Widget _buildMidContainerWithButton() {
    ...
    return (contestdata != null ) ? (contestService.userBooked) ? Stack(
      children: [
        Transform.translate(
                      ...
                      children: [
                        Container(
                          ...
                          child: Icon(Icons.check
                            ,color: ColorConstants.primaryColor2, size: 17, ),
                        ),
                        SizedBox(width:10.h),
                        Text(
                          btnName,
        ...
        Transform.translate(
          ...
          child: Center(
            child: SlidableButton(
              ...
              dismissible: false,
              label: Center(child:  Image.asset("assets/tokens.png",height: 25.h,width: 25.h,),),
              child: Padding(
  ...
  Widget _buildBottomContainer(List<ContestUserData>? contestUserDataList,Contestdata? contestdata) => Flexible(
    flex: 6,
    child: Container(
      color: Colors.white,
            ...
            children: [
              Row(
                ...
                children: [
                  ToggleSwitch(
                    cornerRadius: 40.h,
                    activeBgColors: [[ColorConstants.primaryColor], [ColorConstants.primaryColor]],
                    ...
                    onToggle: (index) async {
                      ...
                      if(index == 0){
                        BlocProvider.of<HomeDashBoardBloc>(context).add(GetLastContestDataEvent(context: context,date: "",contestdata: contestdata));
                      }
                      else if(index == 1){
                        ...
                        BlocProvider.of<HomeDashBoardBloc>(context).add(GetLastContestDataEvent(context: context,date: arr[0].toString(),contestdata: contestdata));
                      }
                    },
                  ),
                ],
              ),
              (contestUserDataList!= null && contestUserDataList.length > 0) ? Column(
                children: [
                  Row(
                    children: [
                      Expanded(
                        flex:1,
                        child: (contestUserDataList != null && contestUserDataList.length >= 2) ? Column(
                          children: [
                            ...
                            SizedBox(
                              ...
                              height: 15.h,
                              child: FittedBox(
                                child: Image.asset('assets/arrow-up.png',color: ColorConstants.primaryColor2, ),
                              ),
                            ),
                            ...
                            Text(contestUserDataList[1].name, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(
                      ...
                      Expanded(
                        flex:1,
                        child: (contestUserDataList != null && contestUserDataList.length >= 1) ? Column(
                          children: [
                            ...
                            Text(contestUserDataList[0].name, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 12.sp,
                            ),),
                            /*Text('@123', style: TextStyle(
                            fontWeight: FontWeight.normal, fontSize: 12
                      ...
                      Expanded(
                        flex:1,
                        child: (contestUserDataList != null && contestUserDataList.length >= 3) ? Column(
                          children: [
                            Padding(padding: EdgeInsets.only(top: 20.h)),
                            ...
                            Text(contestUserDataList[2].name, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 12.sp,
                            ),),
                            /*Text('@123', style: TextStyle(
                            fontWeight: FontWeight.normal, fontSize: 12
                  ...
                  (contestUserDataList!= null && contestUserDataList.length > 3) ? ListView.builder(
                    padding: EdgeInsets.all(0.0),
                        ...
                        child: InkWell(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text((index+3).toString()+".", style: TextStyle(
                                ...
                                Text(contestUserDataList[index+3].name, style: TextStyle(
                ...
                child: dataNotAvailable("No Previous results Available."),
              ),
            ]
        ),
      )
        ...
        child: Stack(
          children: <Widget>[
            Container(
              ...
              margin: EdgeInsets.only(top: Constants.avatarRadius+Constants.padding),
              decoration: BoxDecoration(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("You're booked for this contest , do you want to participate ?",style: TextStyle(fontSize: 14.sp),textAlign: TextAlign.center,),
