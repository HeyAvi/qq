                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(
                            left: 15.w, right: 15.w, bottom: 20.h, top: 30.h),
                        child: TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                errorText: (state.amountMoney.valid)
                                    ? null
                                    : (state.amountMoney.value != "" &&
                                            !state.amountMoney.valid)
                                        ? "Invalid Amount"
                                        : null,
                            ...
                            onChanged: (value) {
                              context
                                  .read<WalletBloc>()
                                  .add(AmountMoneyChanged(amountMoney: value));
                            }),
                      ),
                      SubmitButton()
                    ],
  ...
  Widget build(BuildContext context) {
    return BlocListener<WalletBloc, WalletState>(
      ...
      child: InkWell(
        ...
        onTap: () {
          BlocProvider.of<WalletBloc>(context).add(SubmitWalletEvent(
              context: context,
              amount:
                  BlocProvider.of<WalletBloc>(context).state.amountMoney.value,
              userId: userId,
              status: "COMPLETED"));
        },
      ),
