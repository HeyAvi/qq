...
class ContestProvider {
  ...
  Future<Response?> getContestQuestionDataEvent(BuildContext context, String contestId,String userId) async {
    apiUrl = ApiConstants.BASE_URL + "Contest/"+ApiConstants.fetch_question+contestId+"/"+userId;
  ...
  Future<Response?> submitQuestionDataEvent(BuildContext context ,String contestId,String questionId,String answerGiven,String isAnswerTrue,String moves,String timeTaken) async {
  ...
  Future<Response?> getCompleteQuestionDataEvent(BuildContext context, String contestId,String userId) async {
    apiUrl = ApiConstants.BASE_URL + "Contest/"+ApiConstants.complete_contest+contestId+"/"+userId;
    print("apiUrl=====>>"+apiUrl.toString());
    try {
      Response response = await client.get(apiUrl);
      print("getContestQuestionDataEvent==response===>>"+response.toString());
